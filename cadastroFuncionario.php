...
$Endereco = filter_input(INPUT_POST, 'Endereco', FILTER_SANITIZE_STRING);
    ...
    $sql=mysql_query ("INSERT INTO funcionarios (Nome, Sexo, Telefone, Endereco) values ('$Nome', '$Sexo', '$Telefone', '$Endereco')");

        if($sql)
            echo"<script language='javascript' type='text/javascript'>alert('Cadastro efetuado com sucesso!');window.location.href='funcionarios.php';</script>";
        else
