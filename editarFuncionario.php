<?php
    ...
    $sql= "UPDATE funcionarios SET Nome='$Nome', Sexo='$Sexo', Telefone='$Telefone', Endereco='$Endereco'  WHERE id='$Id'";
    $resultado_funcionarios = mysql_query( $sql, $conexao) or die(mysql_error());
